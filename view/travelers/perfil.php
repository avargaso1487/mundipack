...
if (!isset($_SESSION['usuario'])) {
    ...
    <div class="app app-default">
                                ...
                                <div class="col-xs-12 col-sm-6">
                                    <div class="profile-user-info profile-user-info-striped">
                                        <div class="profile-info-row">
                                            <div class="profile-info-name"> Nombre y Apellidos</div>
                                            <div class="profile-info-value">
                                                <!--Valor se reemplaza esde modelo-->
                                                <span id="traveler_nombres"></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="profile-info-row">
                                            ...
                                            <div class="profile-info-value">
                                                <span id="traveler_direccion"></span>
                                            </div>
                                        </div>
                                        <div class="profile-info-row">
                                            ...
                                            <div class="profile-info-value">
                                                <span id="traveler_nacimiento"></span>
                                            </div>
                                        </div>

                                        <div class="profile-info-row">
                                            <div class="profile-info-name"> T. Fijo</div>

                                            <div class="profile-info-value">
                                                <span id="traveler_fijo"></span>
                                            </div>
                                        </div>

                                        <div class="profile-info-row">
                                            <div class="profile-info-name"> T. Movil</div>

                                            <div class="profile-info-value">
                                                <span id="traveler_movil"></span>
                                            </div>
                                        </div>

                                        <div class="profile-info-row">
                                            <div class="profile-info-name"> Nª Pasaporte</div>

                                            <div class="profile-info-value">
                                                <span id="traveler_pasaporte"></span>
                                            </div>
                                        </div>
        ...
        <script src="../default/js/perfil_travelers.js"></script>

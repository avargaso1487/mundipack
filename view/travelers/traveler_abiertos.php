                        ...
                        <div class="card-body padding">
                            <table class="table-responsive datatable table table-striped primary" cellspacing="0" width="100%" id="tblVentasReg">
                                ...
                                <tr>
                                    ...
                                    <th style="font-size: 12px; text-align: center; height: 10px; width: 10%;">TELEFONO FIJO</th>
                                    <th style="font-size: 12px; text-align: center; height: 10px; width: 8%;">EMAIL</th>
                                    <th style="font-size: 12px; text-align: center; height: 10px; width: 8%;">PAQUETE ELEGIDO</th>
                                </tr>
                                </thead>

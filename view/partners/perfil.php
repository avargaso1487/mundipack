                                ...
                                <div class="col-xs-12 col-sm-3 center">
                                    <div>
                                          <span class="profile-img" id="imagen">
                                            <img class="img-responsive" alt="Net Partner"
                                                 src="view/default/assets/images/users/admin_profile.jpg"/>
                                          </span>
                    ...
                    <div class="modal-dialog">
                            ...
                            <div class="modal-body">
                                ...
                                <form class="form form-horizontal" method="post" id="frm_nuevoSocio"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" placeholder="Razón Social"
                                                   name="socioRazonSocial" id="socioRazonSocial">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" maxlength="11" class="form-control" placeholder="RUC"
                                                   onkeypress="return solonumeros(event)" name="socioRUC" id="socioRUC">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" placeholder="Nombre Comercial"
                                                   name="socioNombreComercial" id="socioNombreComercial">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <select class="form-control" id="socioRubro" name="socioRubro">
                                                <option value="" disabled selected style="display: none;">Seleccionar
                                                    Rubro
                                                </option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <textarea class="form-control" name="socioDireccion"
                                                      id="socioDireccion"></textarea>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-9">
                                            <div class="col-md-6">
                                                <input type="tel" class="form-control"
                                                       ...
                                                       name="socioTelefonoContacto" id="socioTelefonoContacto">
                                            </div>
                                            <div class="col-md-6">
                                                <input type="tel" class="form-control"
                                                       onkeypress="return solonumeros(event)" placeholder="Atención"
                                                       name="socioTelefonoAtencion" id="socioTelefonoAtencion">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input class="form-control" placeholder="Número de Cuenta"
                                                   name="socioNroCuenta" id="socioNroCuenta">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input class="form-control" placeholder="Nombre del Contacto"
                                                   name="socioContactoResponsable" id="socioContactoResponsable">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input class="form-control" placeholder="% de Retorno"
                                                   name="socioPrctjRetorno" id="socioPrctjRetorno">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-2">
                                            <p class="clasificacion">
                                                <input type="radio" name="socioCategoria" id="socioCategoria1"
                                                       value="5"><!--
                        ...
                        --><label for="socioCategoria5">★</label>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <input style="display:none;" type="button" id="guardarSocio"
                                               data-dismiss="modal" class="btn btn-sm btn-primary" onclick="guardar();"
                                               value="Guardar"/>
                                        <input style="display:none;" type="button" id="editarSocio" data-dismiss="modal"
                                               class="btn btn-sm btn-primary" onclick="editar();" value="Modificar"/>
                                    </div>
                                </form>
                            </div>
                        </div>
